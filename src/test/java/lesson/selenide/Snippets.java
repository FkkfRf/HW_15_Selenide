...
public class Snippets {
    ...
    void browser_command_examples() {
        ...
        Selenide.back(); //шаг назад на пред.стр в браузере
        Selenide.refresh(); // перезагрузка стр в браузере
        ...
        Selenide.switchTo().window("The Internet"); //перемещаться между окнами
